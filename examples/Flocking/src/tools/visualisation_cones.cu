...
void initVisualisation()
{
	...
	createVIBO(&coneVertexIndices, (3 * 2 * SPHERE_SLICES) * sizeof(unsigned int));
	setVertexBufferData();
...
void setVertexBufferData()
{
	...
	// upload vertex points data
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, coneVertexIndices);
